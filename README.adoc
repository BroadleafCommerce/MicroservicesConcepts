...
=== Customized Business Logic with Explicit Projection: xref:concepts/01100-businessLogicCustomizationExplicitProjection/README.adoc[01100-businessLogicCustomizationExplicitProjection]
...
=== Endpoint Customization: xref:concepts/01200-endpointCustomization/README.adoc[01200-endpointCustomization]
Simple customization of out-of-the-box `ProductEndpoint`

- Demonstrate a behavior tweak of a single endpoint method

=== Endpoint Customization using AutoProjection: xref:concepts/01300-endpointCustomizationAutoProjection/README.adoc[01300-endpointCustomizationAutoProjection]
...
=== Endpoint Customization using Explicit Projection: xref:concepts/01400-endpointCustomizationExplicitProjection/README.adoc[01400-endpointCustomizationExplicitProjection]
...
=== Brand New Entity: xref:concepts/01500-newDomain/README.adoc[01500-newDomain]
...
=== Brand New Entity with Complex Fields: xref:concepts/01600-newDomainComplexField/README.adoc[01600-newDomainComplexField]
...
=== Tuning Auto Projection with New Entity: xref:concepts/01700-newDomainFineTuneAutoProjection/README.adoc[01700-newDomainFineTuneAutoProjection]
...
=== New Entity with Explicit Projection: xref:concepts/01800-newDomainExplicitProjection/README.adoc[01800-newDomainExplicitProjection]
