...
=== Simple Product Extension : xref:concepts/README.adoc[00100-productExtensionOnly]
...
=== Product Extension with JSON Field: `00200-productExtensionComplexFieldJson`
...
=== Explicit Product Projection: `00300-productExtensionExplicitProjection`
...
=== Product Extension with New Table Relationship: `00400-productExtensionComplexFieldTableBased`
...
=== Product with Nested JSON Collection: `00500-nestedJsonMemberExtension`
...
=== Product with New Nested Table Relationship: `00600-nestedTableBasedMemberExtension`
...
=== Overriding a Repository: `00700-repositoryCustomizationOverride`
...
=== New Repository: `00800-repositoryCustomizationContribution`
...
=== Customizing Business Logic: `00900-businessLogicCustomization`
...
=== Customized Business Logic with Auto Projection: `01000-businessLogicCustomizationAutoProjection`
